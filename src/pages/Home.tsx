  ...
  return (
    <div style={pageContainerStyle}>
      <div style={textContainerStyle}>
        <p>Bonjour-Hi! I'm Ryan, a software developer interested in all matters infrastructure and communities, 2.5+ years of internship and contract experience.</p>
        <br />
        ...
        <br />
        <p>I've also been fortunate to work with unique teams at <a href="https://rbc.com/" target="_blank">RBC</a> (online banking and payments), <a href="https://www.decipad.com/" target="_blank">Decipad</a> (pipelines and interpreters) and Digitera Interactive (native Android).</p>
        <br />
        <p>Currently studying Computer Science at Carleton University in Ottawa and giving back to the community as an executive in the 3,000-member <a href="https://ccss.carleton.ca/">Carleton Computer Science Society</a>, where I manage funding and open-source initiatives.</p>
        <br />
